...
describe('#Routes - test site for api response', () => {
    ...
    test(`GET /home - should response witch ${pages.homeHTML} file stream`, async () => {
        const params = TestUtil.defaultHandlerParams();
        params.request.method = "GET";
    ...
    test(`GET /controller - should response witch ${pages.controllerHTML} file stream`, async () => {
        const params = TestUtil.defaultHandlerParams();
        params.request.method = "GET";
    ...
    test(`GET /index.html - should response witch file stream`, async () => {
        const params = TestUtil.defaultHandlerParams();
    ...
    test(`GET /file.ext - should response witch file stream`, async () => {
        const params = TestUtil.defaultHandlerParams();
    ...
    test(`POST /unknown - given an inexistent route it should response witch 404`, async () => {
        const params = TestUtil.defaultHandlerParams();
